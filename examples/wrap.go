...
func main() {
	...
	if err := dc.LoadFontFace("/usr/share/fonts/gnu-free/FreeSans.otf", 18); err != nil {
	...
	if err := dc.LoadFontFace("/usr/share/fonts/gnu-free/FreeSans.otf", 12); err != nil {
		log.Fatalf("could not load font: %+v", err)
	}
	...
	if err := gg.SavePNG("./testdata/_wrap.png", dc.Image()); err != nil {
